...
// ==============================================================
`timescale 1ns/1ps
module x_order_fir_AXILiteS_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER         = 5'h08,
    ADDR_ISR         = 5'h0c,
    ADDR_COE_DATA_0  = 5'h10,
    ADDR_COE_CTRL    = 5'h14,
    ADDR_CTRL_DATA_0 = 5'h18,
    ADDR_CTRL_CTRL   = 5'h1c,
    WRIDLE           = 2'd0,
    WRDATA           = 2'd1,
    WRRESP           = 2'd2,
    WRRESET          = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_COE_DATA_0)
            int_coe[31:0] <= (WDATA[31:0] & wmask) | (int_coe[31:0] & ~wmask);
    end
end
