...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("y_TUSER", 1, hls_out, 2, "axis", "out_data", 1),
	Port_Property("y_TLAST", 1, hls_out, 3, "axis", "out_data", 1),
	Port_Property("x_TDATA", 32, hls_in, 4, "axis", "in_data", 1),
	Port_Property("x_TVALID", 1, hls_in, 6, "axis", "in_vld", 1),
	Port_Property("x_TREADY", 1, hls_out, 6, "axis", "in_acc", 1),
	Port_Property("x_TUSER", 1, hls_in, 5, "axis", "in_data", 1),
	Port_Property("x_TLAST", 1, hls_in, 6, "axis", "in_data", 1),
...
const char* HLS_Design_Meta::dut_name = "x_order_fir";
