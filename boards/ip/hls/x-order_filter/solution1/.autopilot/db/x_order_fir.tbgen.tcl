...
set C_modelName {x_order_fir}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 0}  }
	{ y_data int 32 regular {axi_s 1 volatile  { y Data } }  }
	{ y_user_V int 1 regular {axi_s 1 volatile  { y User } }  }
	{ y_last_V int 1 regular {axi_s 1 volatile  { y Last } }  }
	{ x_data int 32 regular {axi_s 0 volatile  { x Data } }  }
	{ x_user_V int 1 regular {axi_s 0 volatile  { x User } }  }
	{ x_last_V int 1 regular {axi_s 0 volatile  { x Last } }  }
	{ coe int 32 regular {axi_slave 0}  }
	{ ctrl int 32 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "coe","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "coe","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 1023,"step" : 1}]},{"cName": "ctrl","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "ctrl","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 255,"step" : 1}]}]}]} , 
 	{ "Name" : "y_data", "interface" : "axis", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "y.data","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "x_data", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "x.data","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "coe", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "ctrl", "interface" : "axi_slave", "bundle":"AXILiteS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":24}, "offset_end" : {"in":31}} ]}
...
set portList { 
	...
	{ y_TUSER sc_out sc_lv 1 signal 2 } 
	{ y_TLAST sc_out sc_lv 1 signal 3 } 
	{ x_TDATA sc_in sc_lv 32 signal 4 } 
	{ x_TVALID sc_in sc_logic 1 invld 6 } 
	{ x_TREADY sc_out sc_logic 1 inacc 6 } 
	{ x_TUSER sc_in sc_lv 1 signal 5 } 
	{ x_TLAST sc_in sc_lv 1 signal 6 } 
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"x_order_fir","role":"start","value":"0","valid_bit":"0"},{"name":"x_order_fir","role":"continue","value":"0","valid_bit":"4"},{"name":"x_order_fir","role":"auto_start","value":"0","valid_bit":"7"},{"name":"coe","role":"data","value":"16"},{"name":"ctrl","role":"data","value":"24"}] },
	...
	{ "name": "s_axi_AXILiteS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "AXILiteS", "role": "ARADDR" },"address":[{"name":"x_order_fir","role":"start","value":"0","valid_bit":"0"},{"name":"x_order_fir","role":"done","value":"0","valid_bit":"1"},{"name":"x_order_fir","role":"idle","value":"0","valid_bit":"2"},{"name":"x_order_fir","role":"ready","value":"0","valid_bit":"3"},{"name":"x_order_fir","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "AXILiteS", "role": "interrupt" } }, 
 	...
 	{ "name": "y_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "y_data", "role": "" }} , 
 	{ "name": "y_TVALID", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "y_last_V", "role": "default" }} , 
 	{ "name": "y_TREADY", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "outacc", "bundle":{"name": "y_data", "role": "Y" }} , 
 	...
 	{ "name": "x_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "x_data", "role": "" }} , 
 	{ "name": "x_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "x_last_V", "role": "default" }} , 
 	{ "name": "x_TREADY", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "inacc", "bundle":{"name": "x_last_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.x_order_fir_AXILiteS_s_axi_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.x_order_fir_gmem_m_axi_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	x_order_fir {
		gmem {Type I LastRead 18 FirstWrite -1}
		y_data {Type O LastRead -1 FirstWrite 23}
		y_user_V {Type O LastRead -1 FirstWrite 23}
		y_last_V {Type O LastRead -1 FirstWrite 23}
		x_data {Type I LastRead 22 FirstWrite -1}
		x_user_V {Type I LastRead 22 FirstWrite -1}
		x_last_V {Type I LastRead 22 FirstWrite -1}
		coe {Type I LastRead 0 FirstWrite -1}
		ctrl {Type I LastRead 0 FirstWrite -1}
		coef {Type IO LastRead -1 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	y_data { axis {  { y_TDATA out_data 1 32 }  { y_TREADY out_acc 0 1 } } }
	y_user_V { axis {  { y_TUSER out_data 1 1 } } }
	y_last_V { axis {  { y_TVALID out_vld 1 1 }  { y_TLAST out_data 1 1 } } }
	x_data { axis {  { x_TDATA in_data 0 32 } } }
	x_user_V { axis {  { x_TUSER in_data 0 1 } } }
	x_last_V { axis {  { x_TVALID in_vld 0 1 }  { x_TREADY in_acc 1 1 }  { x_TLAST in_data 0 1 } } }
}
