...
//------------------------Parameter----------------------
`define TV_IN_gmem "../tv/cdatafile/c.x_order_fir.autotvin_gmem.dat"
`define TV_OUT_gmem "../tv/rtldatafile/rtl.x_order_fir.autotvout_gmem.dat"
...
parameter gmem_mem_depth = 32'd 1280;
...
output [32 - 1 : 0] TRAN_gmem_coe;
output [32 - 1 : 0] TRAN_gmem_ctrl;
input ready;
input done;
...
assign    TRAN_gmem_coe = coe;
assign    TRAN_gmem_ctrl = ctrl;
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem_mem_depth) begin
                $display ("C:/Users/weli/Documents/Works/Materials/Training_Materials_WeiLiu/pynq_x-order_fir/ip/hls/x-order_filter/solution1/sim/verilog/AESL_axi_master_gmem.v: Write request address %d exceed AXI master gmem array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem_mem_depth) begin
                $display ("C:/Users/weli/Documents/Works/Materials/Training_Materials_WeiLiu/pynq_x-order_fir/ip/hls/x-order_filter/solution1/sim/verilog/AESL_axi_master_gmem.v: Read request address %d exceed AXI master gmem array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem_mem_depth); 
                $finish;
            end
