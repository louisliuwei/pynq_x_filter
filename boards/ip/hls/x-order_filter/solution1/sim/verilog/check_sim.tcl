...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.x_order_fir.autotvin_gmem.dat"
         "c.x_order_fir.autotvin_y_data.dat"
         "c.x_order_fir.autotvin_y_user_V.dat"
         "c.x_order_fir.autotvin_y_last_V.dat"
         "c.x_order_fir.autotvin_x_data.dat"
         "c.x_order_fir.autotvin_x_user_V.dat"
         "c.x_order_fir.autotvin_x_last_V.dat"
         "c.x_order_fir.autotvin_coe.dat"
         "c.x_order_fir.autotvin_ctrl.dat"
         "c.x_order_fir.autotvout_y_data.dat"
         "c.x_order_fir.autotvout_y_user_V.dat"
         "c.x_order_fir.autotvout_y_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.x_order_fir.autotvout_y_data.dat"
         "rtl.x_order_fir.autotvout_y_user_V.dat"
         "rtl.x_order_fir.autotvout_y_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
