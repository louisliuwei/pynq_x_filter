...
if {[file isfile x_order_fir.autotvin.dat]} {
	file delete -force x_order_fir.autotvin.dat
}

if {[file isfile x_order_fir.autotvout.dat]} {
	file delete -force x_order_fir.autotvout.dat
}
