# ==============================================================
# File generated on Mon Oct 07 02:00:04 +0800 2019
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "x_order_fir.autotvin.dat"
	set constFileTvOut       "x_order_fir.autotvout.dat"
	set constFileHdlTvIn     "x_order_fir.autohdltvin.dat"
	set constFileHdlTvOut    "x_order_fir.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
