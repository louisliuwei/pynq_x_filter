# ==============================================================
# File generated on Mon Oct 07 01:59:55 +0800 2019
...
$(ObjDir)/x_order_fir.cpp_pre.cpp.tb.o : x_order_fir.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling x_order_fir.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
